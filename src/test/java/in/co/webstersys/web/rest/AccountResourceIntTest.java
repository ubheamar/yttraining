package in.co.webstersys.web.rest;

import in.co.webstersys.config.Constants;
import in.co.webstersys.YttrainingApp;
import in.co.webstersys.domain.Authority;
import in.co.webstersys.domain.User;
import in.co.webstersys.repository.AuthorityRepository;
import in.co.webstersys.repository.UserRepository;
import in.co.webstersys.security.AuthoritiesConstants;
import in.co.webstersys.service.MailService;
import in.co.webstersys.service.dto.UserDTO;
import in.co.webstersys.service.dto.PasswordChangeDTO;
import in.co.webstersys.web.rest.errors.ExceptionTranslator;
import in.co.webstersys.web.rest.vm.KeyAndPasswordVM;
import in.co.webstersys.web.rest.vm.ManagedUserVM;
import in.co.webstersys.service.UserService;
...
@SpringBootTest(classes = YttrainingApp.class)
